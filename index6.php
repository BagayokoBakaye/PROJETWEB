...
<body>
    <div class="wrapper">
        ...
        <div  class="g1">
                <button id="button" onclick="showhide()" style="background-color:#4d9754; color:white;width: 115px;
                border:#4d9754; margin-left: 6px;"><i class="fas fa-sliders-h" style="font-size: 40px;"></i></button>
                <div id="newpost"  class="hidden" style="margin-top: 5px; color:white; font-size:15px;">
                    <h3>Store</h3>
                </div>  
            </div>
                <div  class="g1">
                    <button id="button" onclick="showhide1()" style="background-color:#4d9754; color:white;width: 115px;
                    border:#4d9754; margin-left: 7px;"><i class="fa-solid fa-users" style="font-size: 40px;"></i></button>
                    <div id="newpost1"  class="hidden1" style="margin-top: 5px; color:white; font-size:15px;">
                        <h3>Utilisateurs</h3>
                    </div>  
                </div>
                <div  class="g1">
                    <button id="button" onclick="showhide2()" style="background-color:#4d9754; color:white;width: 115px;
                    border:#4d9754; margin-left: 7px;"><i class="fa-solid fa-circle-info" style="font-size: 40px;"></i></button>
                    <div id="newpost2"  class="hidden2" style="margin-top: 5px; color:white; font-size:15px;">
                        <h3>Logs</h3>
                    </div>  
                </div>
                <div  class="g1">
                    <button id="button" onclick="showhide3()" style="background-color:#4d9754; color:white;width: 115px;
                    border:#4d9754; margin-left: 8px;"><i class="fa-solid fa-right-from-bracket" style="font-size: 40px;"></i></button>
