...
<body>
    <div class="wrapper">
        <div class="sidebar">
            ...
            <div  class="g1">
               <a href="index5.php"> <button id="button" onclick="showhide()" style=" background-color: rgb(82, 197, 82); color:white;width: 115px;
                ...
                <div  class="g1">
                <a href="index8.php"> <button id="button" onclick="showhide1()" style=" background-color: rgb(82, 197, 82); color:white;width: 115px;
        ...
        <form method="post" action ="index7.php" enctype="multipart/form-data">
